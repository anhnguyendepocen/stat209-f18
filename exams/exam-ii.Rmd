---
title: "Exam II: Graphics and Filtering"
...
fill in R code where required. The only difference is that you must work on the
exam external help. You may consult the class notes or look up help online, but
may not discuss with classmates or directly ask questions of others. If you have
any questions about this policy, please ask me first before using a resource.

In each section there is exactly one plot that you need to create. Make sure
that in every plot you label the axes and (if applicable) any legends that are
created.

The completed Rmarkdown file must be submitted by 5pm on October 22nd (Monday)
in the 'exams' directory on your GitHub repository. I suggest that you knit and
produce an HTML version of the exam (it is a good way to check that your code
runs correctly), it is not required and you do not need to submit this file.
...
The dataset for this exam consists of a single year of observed weather data
